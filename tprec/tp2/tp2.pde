...
void draw() {
  ...
  // escena 5
    ...
    mostrarEscena(
      naruto5,
      "Después de muchos años, Naruto se convirtió en Hokage",
      255, 180, 100
      );
  }
...
void moverEstrellas() {
  ...
  if (estrellaY1 > height) estrellaY1 = 0;
  if (estrellaY2 > height) estrellaY2 = 0;
  if (estrellaY3 > height) estrellaY3 = 0;
  if (estrellaY4 > height) estrellaY4 = 0;
  if (estrellaY5 > height) estrellaY5 = 0;
  if (estrellaY6 > height) estrellaY6 = 0;
  if (estrellaY7 > height) estrellaY7 = 0;
  if (estrellaY8 > height) estrellaY8 = 0;
}
